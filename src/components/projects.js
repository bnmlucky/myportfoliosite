...
class Projects extends Component {
    ...
    toggleCategories() {
        if (this.state.activeTab === 0) {
            return (
                //Project 1
                < Card shadow={5} style={{ minWidth: '450', padding: '10px', margin: 'auto' }
                }>
                    ...
                    <CardActions border>
                        ...
                        <Button href="http://wellness-tracker-app.surge.sh/" target="_blank" colored>Live Site</Button>
                    </CardActions>
            ...
            return (
                <div className="projects-grid">
                    < Card shadow={5} style={{ minWidth: '450', height: '500', padding: '3px', margin: 'auto' }
                    }>
                        ...
                        <CardText>
                            Frowsy is a self-organization app that was done as a group project at General Assembly Software Engineering Immersive course.
                    </CardText>
                        <CardActions border>
                            <Button href="https://github.com/bnmlucky/frowsy-back-end" target="_blank" colored>GitHub</Button>
                            <Button href="http://scintillating-wheel.surge.sh/Home" target="_blank" colored>Live Site</Button>
                        </CardActions>
                        <CardMenu style={{ color: 'fff' }}>
                            <IconButton name="share" />
                        </CardMenu>
                    ...
                    < Card shadow={5} style={{ minWidth: '450', height: '500', padding: '3px', margin: 'auto' }
                        ...
                        <CardActions border>
                            ...
                            <Button href="https://todoapp-natalia.herokuapp.com/todos" target="_blank" colored>Live Site</Button>
                        </CardActions>
                        <CardMenu style={{ color: 'fff' }}>
                            <IconButton name="share" />
                        </CardMenu>
            ...
            return (
                < Card shadow={5} style={{ minWidth: '450', height: '500', padding: '10px', margin: 'auto' }
                }>
